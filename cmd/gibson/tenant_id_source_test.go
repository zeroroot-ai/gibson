...
func TestTenantIDSource(t *testing.T) {
	...
	allowlist := map[string]string{
		...
		"internal/daemon/api/tenant_admin_langfuse_get.go:35":      "platform-operator action; req.TenantId is the object being acted upon, not the authz subject",
		...
		"internal/daemon/api/tenant_admin_langfuse_get.go:47":      "platform-operator action; req.TenantId is the object being acted upon, not the authz subject",
		...
		"internal/daemon/api/tenant_admin_langfuse_get.go:53":      "platform-operator action; req.TenantId is the object being acted upon, not the authz subject",

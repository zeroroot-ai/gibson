...
func TestNoTimeNowInRPCHandlers(t *testing.T) {
	...
	allowlist := astchecks.Allowlist{
		...
		"internal/server/daemon/api/server_provider_config.go:334": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "latency-measurement start for provider check"},
		"internal/server/daemon/api/server_provider_config.go:466": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "`checkedAt` field on provider check response"},
		"internal/server/daemon/api/server_provider_config.go:591": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "latency-measurement start for provider check"},
		...
		"internal/server/daemon/api/server.go:1117": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "session ID generation uses wall-clock Unix epoch"},
		"internal/server/daemon/api/server.go:1136": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "response `Timestamp` field; wall-clock Unix"},
		"internal/server/daemon/api/server.go:1482": astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "latency-measurement start"},

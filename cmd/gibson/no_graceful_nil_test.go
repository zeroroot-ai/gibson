...
func TestNoGracefulNilInRequestPaths(t *testing.T) {
	...
	requestPathAllowlist := astchecks.Allowlist{
		...
		"internal/daemon/grpc.go:2101":                  astchecks.Entry{Category: astchecks.CategoryLegacyOptional, Reason: "pool nil-guard in populateCheckpointPayload; pool-required follow-up"},
		"internal/daemon/grpc.go:2111":                  astchecks.Entry{Category: astchecks.CategoryDefensiveGuard, Reason: "compound nil-check on mission store Get result + Checkpoint proto field in populateCheckpointPayload"},
		"internal/daemon/grpc.go:2406":                  astchecks.Entry{Category: astchecks.CategoryLegacyOptional, Reason: "pool nil-guard; pool-required follow-up (one-code-path#195)"},

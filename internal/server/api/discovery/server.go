...
// connectors may be nil (see Server.connectors).
func NewServer(az authz.Authorizer, reg component.ComponentRegistry, connectors ConnectorLister, logger *slog.Logger) *Server {
	if logger == nil {
		logger = slog.Default()
	}
	return &Server{

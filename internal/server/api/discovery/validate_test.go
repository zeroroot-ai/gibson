...
// internal/server/api/ had zero test files prior to this; the goal here is one
...
import (
	...
	"github.com/zeroroot-ai/gibson/internal/server/api/discovery"
)
...
func TestValidateComponent_EmptyComponentYaml_ReportsRequiredSchemaError(t *testing.T) {
	srv := discovery.NewServer(nil /*authorizer*/, nil /*registry*/, nil /*connectors*/, nil /*logger*/)

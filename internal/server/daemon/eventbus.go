...
// api.EventData (daemon-specific). It cannot be moved to internal/engine/events/
// without circular imports (internal/events cannot import internal/server/daemon/api).

...
type DaemonOperatorServiceClient interface {
	...
	EnqueueTenantProvisioning(ctx context.Context, in *EnqueueTenantProvisioningRequest, opts ...grpc.CallOption) (*EnqueueTenantProvisioningResponse, error)
...
func (c *daemonOperatorServiceClient) EnqueueTenantProvisioning(ctx context.Context, in *EnqueueTenantProvisioningRequest, opts ...grpc.CallOption) (*EnqueueTenantProvisioningResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EnqueueTenantProvisioningResponse)
	err := c.cc.Invoke(ctx, DaemonOperatorService_EnqueueTenantProvisioning_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonOperatorServiceServer interface {
	...
	// exactly as a signup-originated op. Idempotent on tenant_id: an already
	// pending provision op returns already_existed=true and no new row.
	EnqueueTenantProvisioning(context.Context, *EnqueueTenantProvisioningRequest) (*EnqueueTenantProvisioningResponse, error)
	// AckTenantProvisioned marks a pending-provisioning record done so it is not
	// re-created on the next reconcile pass. The operator calls this AFTER it has
	// ensured the Tenant CR exists (create or already-present), so a crash
	// between create and ack simply re-lists the row and the operator's
...
func (UnimplementedDaemonOperatorServiceServer) EnqueueTenantProvisioning(context.Context, *EnqueueTenantProvisioningRequest) (*EnqueueTenantProvisioningResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method EnqueueTenantProvisioning not implemented")
}
...
func _DaemonOperatorService_EnqueueTenantProvisioning_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EnqueueTenantProvisioningRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonOperatorServiceServer).EnqueueTenantProvisioning(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonOperatorService_EnqueueTenantProvisioning_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonOperatorServiceServer).EnqueueTenantProvisioning(ctx, req.(*EnqueueTenantProvisioningRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _DaemonOperatorService_RevokeConnectorGrant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeConnectorGrantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonOperatorServiceServer).RevokeConnectorGrant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonOperatorService_RevokeConnectorGrant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonOperatorServiceServer).RevokeConnectorGrant(ctx, req.(*RevokeConnectorGrantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonOperatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnqueueTenantProvisioning",
			Handler:    _DaemonOperatorService_EnqueueTenantProvisioning_Handler,
		},
		{

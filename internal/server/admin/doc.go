...
// connections via internal/infra/datapool/admin.AdminPool.
//
// # Scope
//
...
//   - Fleet metrics: cross-tenant catalog state is read at the FGA
//     layer only (no data-plane access) and stays in internal/infra/reconciler/.

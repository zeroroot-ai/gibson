...
const (
	...
	DaemonService_GetTenantByEmail_FullMethodName                = "/gibson.daemon.v1.DaemonService/GetTenantByEmail"
...
type DaemonServiceClient interface {
	...
	RunAttack(ctx context.Context, in *RunAttackRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunAttackResponse], error)
...
func (c *daemonServiceClient) RunAttack(ctx context.Context, in *RunAttackRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[RunAttackResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &DaemonService_ServiceDesc.Streams[1], DaemonService_RunAttack_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[RunAttackRequest, RunAttackResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DaemonService_RunAttackClient = grpc.ServerStreamingClient[RunAttackResponse]
...
func (c *daemonServiceClient) GetTenantByEmail(ctx context.Context, in *GetTenantByEmailRequest, opts ...grpc.CallOption) (*GetTenantByEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTenantByEmailResponse)
	err := c.cc.Invoke(ctx, DaemonService_GetTenantByEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServiceServer interface {
	...
	// RunAttack executes an attack and streams progress events.
	// The stream remains open until the attack completes or is stopped.
	RunAttack(*RunAttackRequest, grpc.ServerStreamingServer[RunAttackResponse]) error
	// Subscribe establishes an event stream for TUI real-time updates.
	// Streams mission events, agent events, finding events, etc.
...
func (UnimplementedDaemonServiceServer) RunAttack(*RunAttackRequest, grpc.ServerStreamingServer[RunAttackResponse]) error {
...
func (UnimplementedDaemonServiceServer) GetTenantByEmail(context.Context, *GetTenantByEmailRequest) (*GetTenantByEmailResponse, error) {
...
func _DaemonService_RunAttack_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(DaemonServiceServer).RunAttack(m, &grpc.GenericServerStream[RunAttackRequest, RunAttackResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type DaemonService_RunAttackServer = grpc.ServerStreamingServer[RunAttackResponse]
...
func _DaemonService_GetTenantByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTenantByEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).GetTenantByEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_GetTenantByEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).GetTenantByEmail(ctx, req.(*GetTenantByEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DaemonService_GetTenantByEmail_Handler,
		},
		{

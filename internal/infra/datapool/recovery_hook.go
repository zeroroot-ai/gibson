...
// internal/server/daemon/recover_missions.go, which iterated every Tenant CRD at
...
// internal/server/daemon/recover_missions.go used to do at startup, except now

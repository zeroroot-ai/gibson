...
func TestFinding_RaisedAndReplay(t *testing.T) {
	...
	// A raised Finding defaults to open (gibson#1656): status lives on the
	// Finding and a node never carries an empty one.
	want := []FindingSnapshot{{
		ID: "f1", Title: "exposed jenkins", ScopeID: "s", Address: "10.0.0.5",

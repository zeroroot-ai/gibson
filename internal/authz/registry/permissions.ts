...
export const AuthRegistry: Record<string, AuthEntry> = {
  ...
  "/gibson.traces.v1.TracesService/AddTraceScore": {
    method: "/gibson.traces.v1.TracesService/AddTraceScore",
    service: "gibson.traces.v1.TracesService",
    relation: "member",
    objectType: "tenant",
    objectDeriver: "tenant_from_identity",
    allowedIdentities: IdentityClass.USER | IdentityClass.SERVICE,
  ...
  "/gibson.traces.v1.TracesService/GetObservation": {
    method: "/gibson.traces.v1.TracesService/GetObservation",
    service: "gibson.traces.v1.TracesService",
    relation: "member",
    objectType: "tenant",
    objectDeriver: "tenant_from_identity",
  ...
  "/gibson.traces.v1.TracesService/GetTrace": {
    method: "/gibson.traces.v1.TracesService/GetTrace",
    service: "gibson.traces.v1.TracesService",
    relation: "member",
    objectType: "tenant",
    objectDeriver: "tenant_from_identity",
  ...
  "/gibson.traces.v1.TracesService/ListTraces": {
    method: "/gibson.traces.v1.TracesService/ListTraces",
    service: "gibson.traces.v1.TracesService",
    relation: "member",
    objectType: "tenant",
    objectDeriver: "tenant_from_identity",

...
export const AuthRegistry: Record<string, AuthEntry> = {
  ...
  "/gibson.tenant.v1.SignupService/CheckTenantSlugAvailable": {
    method: "/gibson.tenant.v1.SignupService/CheckTenantSlugAvailable",
  ...
  "/gibson.tenant.v1.TenantService/GetTenantProvisioningStatus": {
    method: "/gibson.tenant.v1.TenantService/GetTenantProvisioningStatus",
    service: "gibson.tenant.v1.TenantService",
    relation: "member",
    objectType: "tenant",
    objectDeriver: "tenant_from_identity",

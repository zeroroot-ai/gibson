	...
	fga := &fakeFGA{
		resolve: func(ctx context.Context, userID, tenantID string) ([]capabilitygrant.Capability, error) {
			return []capabilitygrant.Capability{
				...
				{Name: "configure:plugin:gitlab", ComponentRef: "component:plugin/gitlab", Kind: "plugin"},
			}, nil
		},
	}
	...
	fga := &fakeFGA{
		resolve: func(ctx context.Context, userID, tenantID string) ([]capabilitygrant.Capability, error) {
			if userID == "owner-1" {
				return []capabilitygrant.Capability{
					{Name: "execute:tool:nmap", ComponentRef: "component:tool/nmap", Kind: "tool"},
					{Name: "execute:tool:sslyze", ComponentRef: "component:tool/sslyze", Kind: "tool"},
				}, nil
			}
...
func TestBuilder_CrossComponentRulesPropagate(t *testing.T) {
	fga := &fakeFGA{
		resolve: func(ctx context.Context, userID, tenantID string) ([]capabilitygrant.Capability, error) {
			return []capabilitygrant.Capability{
				{Name: "execute:tool:nmap", ComponentRef: "component:tool/nmap", Kind: "tool"},
				{Name: "execute:plugin:gitlab", ComponentRef: "component:plugin/gitlab", Kind: "plugin"},
			}, nil
		},
		crossRules: func(ctx context.Context, subjectFGA string, components []capabilitygrant.ComponentRef) ([]capabilitygrant.CrossRule, error) {
			return []capabilitygrant.CrossRule{
				{Source: subjectFGA, Target: "component:plugin/gitlab", Effect: capabilitygrant.EffectDeny, Reason: "fga_deny"},
			}, nil
		},
	}
	reg := &fakeRegistry{infos: []component.ComponentInfo{
	...
	if rule.SourceComponentRef != "user:alice" || rule.TargetComponentRef != "component:plugin/gitlab" {

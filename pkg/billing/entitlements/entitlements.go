...
//     unlimited. No payment. Absence means unlimited ONLY while
//     GIBSON_ENTITLEMENTS_REQUIRED is unset — see the ConfigProvider read path,
//     which denies on a missing row once entitlements are declared required.
//

...
authz-registry:
	...
	@rm -rf .tmp/ws
	@echo "Building FDS from platform-sdk protos (local workspace — SDK resolved locally, no BSR for renamed org)..."
	...
	@SDK_DIR=$$($(GOCMD) list -m -f '{{.Dir}}' github.com/zeroroot-ai/sdk); \
	  ...
	  rm -rf .tmp/psdk-ws && mkdir -p .tmp/psdk-ws && \
	  ln -sfn "$$PSDK_DIR/proto" .tmp/psdk-ws/platform-sdk-proto && \
	  ln -sfn "$$SDK_DIR/api/proto" .tmp/psdk-ws/sdk-proto && \
	  printf 'version: v2\nmodules:\n  - path: platform-sdk-proto\n  - path: sdk-proto\n    excludes:\n      - sdk-proto/google\ndeps:\n  - buf.build/bufbuild/protovalidate\n' > .tmp/psdk-ws/buf.yaml && \
	  printf '# Generated by buf. DO NOT EDIT.\nversion: v2\ndeps:\n  - name: buf.build/bufbuild/protovalidate\n    commit: 50325440f8f24053b047484a6bf60b76\n    digest: b5:74cb6f5c0853c3c10aafc701614194bbd63326bdb8ef4068214454b8894b03ba4113e04b3a33a8321cdf05336e37db4dc14a5e2495db8462566914f36086ba31\n' > .tmp/psdk-ws/buf.lock && \
	  cd .tmp/psdk-ws && $(BUF) build platform-sdk-proto -o $(CURDIR)/.tmp/platform-sdk-fds.binpb
	@rm -rf .tmp/psdk-ws

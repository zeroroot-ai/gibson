...
func (s *stubFGA) WriteAndDelete(_ context.Context, _, _ []fga.Tuple) error { return nil }
func (s *stubFGA) WriteConditional(_ context.Context, _ fga.ConditionalTuple) error {
	return nil
}

...
func (r *recordingFGA) WriteAndDelete(_ context.Context, _, _ []fga.Tuple) error { return nil }
func (r *recordingFGA) WriteConditional(_ context.Context, _ fga.ConditionalTuple) error {
	return nil
}

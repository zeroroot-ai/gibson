...
// gibsoncheck rule. It calls secrets Get/Resolve but uses the returned bytes
// only for legitimate purposes — never passing them to a logging sink. The
// analyzer must emit zero diagnostics against this package.

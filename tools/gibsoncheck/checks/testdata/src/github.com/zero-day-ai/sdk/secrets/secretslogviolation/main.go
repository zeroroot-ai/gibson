...
// secretsnolog gibsoncheck rule. It deliberately passes the return value of
// a secrets Get/Resolve call to several logging sinks so that the analyzer
// fires a diagnostic on each flagged line.
